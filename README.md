...
> 截止此版本（**v1.0.57**）两个扩展商店已累计下载超 **5513+** 次，欢迎大家去[**Issue**](https://github.com/zdt1013/ai-git-commiter/issues/)提交反馈和需求。
...
## 🕑 更新历史
- **v1.0.59**
  * 修复：修复 GLM 5.3 生成空提交信息 [PR #16](https://github.com/zdt1013/ai-git-commiter/pull/16)

- **v1.0.58**
  * 修复：新增无 Emoji 版本的默认提示词模板后，默认模板为含Emoji的模板。

- **v1.0.57**
  * 新增：新增无 Emoji 版本的默认提示词模板，可通过「选择提示词模板」快捷命令更换使用。

- **v1.0.56**
  * 修复：升级到最新版 VS Code 后使用 OpenAI 接口报网络错误的问题。
  * 新增：新增包含Git变更信息摘要配置，更好的让AI识别变更内容的上下文信息，默认开启
...
- **v1.0.45**
  ...
  * 同时修复使用多工作区时，点击插件只为第一个仓库生成Message的问题。
